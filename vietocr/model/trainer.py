...
#            **config['optimizer'])
    ...
    def train(self):
        ...
        for i in range(self.num_iters):
            ...
            print(f'iter x print_every x valid_every => {self.iter}/{self.num_iters} x {self.print_every} x {self.valid_every}')
            ...
            if self.valid_annotation and self.iter % self.valid_every == 0:
                ...
                print(f'acc_full_seq x best_acc => {acc_full_seq} x {best_acc}')
...
#                loss = self.criterion(rearrange(outputs, 'b t v -> (b t) v'), rearrange(tgt_output, 'b o -> (b o)'))
    ...
    def precision(self, sample=None):
        ...
        print(f'pred_sents x actual_sents => {pred_sents} x {actual_sents}')
